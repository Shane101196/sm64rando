...
public class Sm64_Randomizer {
	/* https://github.com/Dabomstew/universal-pokemon-randomizer/blob/master/src/com/dabomstew/pkrandom/FileFunctions.java */
	/* File reading and formatting methods */
	...
	// Disables the Cyclic Redundancy Check to allow to edit the file without needing to update CRC checksum.
	...
	//Gets acceptable enemy values based on map
	...
	public static boolean checkValidSpawn(StringBuilder sb, int val, List<String> colVerts1, List<String> colTris1) {
		...
		//Split each point into x,y,z coords
		//x1
		...
		//Logic to check if wall or floor or ceiling.
